...
const sl: GuestStrings = {
  ...
  visitsLeft: (n, r) => `Še ${n} ${n === 1 ? "obisk" : n === 2 ? "obiska" : "obiskov"} do brezplačne ${r}.`,
...
const en: GuestStrings = {
  ...
  visitsLeft: (n, r) => `${n} more ${n === 1 ? "visit" : "visits"} to a free ${r}.`,
...
const hr: GuestStrings = {
  ...
  visitsLeft: (n, r) => `Još ${n} ${n === 1 ? "posjet" : "posjeta"} do besplatne ${r}.`,
...
const de: GuestStrings = {
  ...
  visitsLeft: (n, r) => `Noch ${n} ${n === 1 ? "Besuch" : "Besuche"} bis zum gratis ${r}.`,
