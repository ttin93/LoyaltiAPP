...
-- Vrne (total, card_completed). Za per_visit pošlji p_card_goal = cilj kartončka:
-- ob dosegu se card_completed=true in točke se resetirajo z ostankom. Za per_euro p_card_goal=0.
